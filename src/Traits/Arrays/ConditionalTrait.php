...
trait ConditionalTrait
{
	 ...
	 *
	 * @param	callable	$callback	The callback function which defines the rule. If each and
	 ...
	 * a specific condition,
	 *
	 * @param	callable	$callback	The callback function which defines the rule. If any element
